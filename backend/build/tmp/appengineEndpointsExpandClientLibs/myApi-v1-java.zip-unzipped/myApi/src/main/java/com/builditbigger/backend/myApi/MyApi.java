 ...
 * on 2016-09-23 at 17:01:28 UTC 
 * Modify at your own risk.
 */

package com.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-it-bigger-123123.appspot.com/_ah/api/";
  ...
  public class GetAllJokes extends MyApiRequest<com.builditbigger.backend.myApi.model.MyBeanCollection> {

    private static final String REST_PATH = "mybeancollection";
    ...
    protected GetAllJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.builditbigger.backend.myApi.model.MyBeanCollection.class);
    }
  ...
  public class GetJoke extends MyApiRequest<com.builditbigger.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.builditbigger.backend.myApi.model.MyBean.class);
    }
